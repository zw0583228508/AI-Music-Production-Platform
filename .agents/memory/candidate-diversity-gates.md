...
**How to apply:** Any new generation provider, critic, repair loop, or ranking rule must preserve the base-seed/derived-seed identity, extend canonical fingerprints only with musical evidence, and keep rejected near-duplicates outside selection.