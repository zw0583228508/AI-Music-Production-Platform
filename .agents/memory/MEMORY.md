...
- [Modal digest-only image references](modal-digest-only-image-references.md) — pinned external image stages must use repository@sha256, because Modal rejects tag@sha256 COPY sources.
