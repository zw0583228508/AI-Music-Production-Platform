...
def evidence_errors(rows, root):
    ...
    if anyaccomp.get("finalStatus") == "READY":
        ...
        try:
            ...
            public_key, output_sha, generated, committed, license_review_sha = "", "", "", {}, ""
        ...
        source_digest = "sha256:aed30e61de548b1d9bb12c714697394ca61c888381c22de1ac498354b9873bde"
        record = bundle.get("record", {})
        health = release.get("liveHealth", {})
        ...
        required = [
            ...
            observed.get("modalDeploymentId") == "v7",
            refresh.get("modalDeploymentId") == "v7",
            refresh.get("staleContainerIds") == [],
            worker.get("MUSIC_GPU_MODAL_DEPLOYMENT_ID") == "v7",
            release.get("sourceRevision") == source_revision,
            ...
            live_generation.get("modalDeploymentId") == "v7",
