...
export const MUSIC_PROVIDERS: MusicProviderDescriptor[] = [
  {
    ...
    version: "1.0.0",
    capabilities: ["structure", "harmony"],
  ...
  },
  {
    ...
    license: "Apache-2.0",
    priority: 70,
    notes: "Adapter contract is registered; model runtime is not installed yet.",
  },
  {
    id: "MT3",
    name: "MT3",
  ...
  },
  {
    ...
    license: "Model-specific",
    priority: 100,
    notes: "Adapter contract is registered; GPU runtime is not installed yet.",
  },
];
